...
from benchmarking_functions import rastrigin as rastrigin_benchmark
...
def run_rastrigin_test(run_num, total_runs, params):
    ...
    def rastrigin(individual):
        ...
        try:
            ...
            scaled_individual = scale_individual(
                individual, source_bounds, target_bounds
            )
...
def main(num_executions):
    ...
    results = [
        run_rastrigin_test(i, num_executions, params.copy())
    ...
    valid_fitnesses = [
        r["best_fitness"] for r in results if r["best_fitness"] != float("inf")
    ]
    if valid_fitnesses:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Executa o Algoritmo Genético com a função Rastrigin."
    )
    parser.add_argument(
        "-n",
        "--num_executions",
