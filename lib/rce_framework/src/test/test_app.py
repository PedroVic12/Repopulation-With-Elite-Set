...
from LauncherGUI.app.models.executer_model import ScriptWorker
from LauncherGUI.app.models.config_manager import ConfigManager

from LauncherGUI.app.views.tabs_page import ConfigTab
...
def test_config_tab_generate_configurations(qtbot, config_manager):
    ...
    tab.param_widgets["MUTACAO"]["mode"].buttons()[1].setChecked(
        True
    )  # Clica em "Variável"
    ...
    )  # 2 valores de MUTACAO * 2 valores de POP_SIZE = 4 configs
