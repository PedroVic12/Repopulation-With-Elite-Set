...
from src.AlgEvolutivoRCE_backup.Setup import Setup
from src.AlgEvolutivoRCE_backup.alg_evolutivo_rce import AlgoritimoEvolutivoRCE
...
def run_rastrigin_test(run_num, params=None):
    ...
    params.update({
        ...
        'RCE_REPOPULATION_GENERATIONS': params.get('RCE_REPOPULATION_GENERATIONS', 50),
