...
class Setup:
    def __init__(self, params, dadosEntrada=None):
        ...
        # Variavel de decisão com os valores de X e Y
        #self.toolbox.register("attribute", random.choice, X + Y)
        #! DO JEITO ACIMA?

        # Define os tipos de variáveis de decisão
        self.toolbox.register("attr_float", random.uniform, -5.12, 5.12)  # x: float entre -5.12 e 5.12
        self.toolbox.register("attr_int", random.randint, 1, 10)      # y: int entre 1 e 10
