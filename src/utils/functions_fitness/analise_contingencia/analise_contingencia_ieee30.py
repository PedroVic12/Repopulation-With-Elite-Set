...
if __name__ == "__main__":
    ...
    setup = Setup(params=params, fitness_function=funcao_objetivo_ieee30_analise, tamanho_hash=hashtablesize_ieee30())
    fitness, = funcao_objetivo_ieee30_analise(individuo=horarios_teste, setupobj=setup)
