...
contingencia_df_3 = pd.DataFrame([
    {"contingencia": 1, "from": 0, "to": 1}
])
...
def funcao_objetivo_SEP3(individuo, setupobj, _debug=False):
    ...
    return generic_funcao_objetivo(individuo, setupobj, rede, agendamento_df_3, contingencia_df_3, _debug)
...
contingencia_df_5 = pd.DataFrame([
    {"contingencia": 1, "from": 0, "to": 1}
])
...
def funcao_objetivo_SEP5(individuo, setupobj, _debug=False):
    ...
    return generic_funcao_objetivo(individuo, setupobj, rede, agendamento_df_5, contingencia_df_5, _debug)
...
contingencia_df_9 = pd.DataFrame([
    {"contingencia": 1, "from": 0, "to": 3}
])
...
def funcao_objetivo_SEP9(individuo, setupobj, _debug=False):
    ...
    return generic_funcao_objetivo(individuo, setupobj, rede, agendamento_df_9, contingencia_df_9, _debug)


# =====================================================
# FUNÇÃO GENÉRICA (Baseada na IEEE 14)
# =====================================================
def generic_funcao_objetivo(individuo, setupobj, rede, agendamento_df, contingencia_df, _debug=False):
