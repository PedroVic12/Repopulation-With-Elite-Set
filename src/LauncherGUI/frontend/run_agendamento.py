...
Update: 16/09/25 - PVRV
"""


#! Esta nova versão tem o foco de usar o Framework usando modulos e funcoes de subrotinas em arquivos separados com foco em diagnosticar  a execução que esta repetindo 2x na configuração inicial
